...
function Register({ isModal = false, onClose }) {
      ...
      <div className="relative p-8 sm:p-10">
        ...
        {isModal && (
          <button
            type="button"
            onClick={onClose}
            className="absolute right-6 top-6 flex h-9 w-9 items-center justify-center rounded-lg text-xl text-slate-500 transition hover:bg-white/10 hover:text-white"
